...
use crate::{
    NewLocalTerminal, OpenSftp, PendingCommand, SerialParams, SshParams, TermuaAppState,
...
impl TermuaWindow {
    ...
    fn build_terminal_panel(
        ...
        let env = match kind {
            ...
            PanelKind::Ssh | PanelKind::Serial => env,
        };
        ...
        let tab_label = match kind {
            ...
            PanelKind::Ssh | PanelKind::Serial => {
